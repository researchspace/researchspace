...
public class ReadConnection {
    ...
    /**
     * Returns a set of non-cached rdf:type (s) for the specified subject or empty
     * set otherwise.
     * 
     * @param subject
     * @return
     ...
     * 
     * @see RepositoryConnection#hasStatement(Resource, IRI, Value, boolean,
     *      Resource...)
     * @param resource
     * @param uri
     * @param value
    ...
    /**
     * Returns all out-going statements for the specified subject. Subject must not
     * be not.
     * 
     * @param subject
     * @return
    ...
    /**
     * Returns all statements in the specified named graph aka context. Context must
     * not be null.
     * 
     * @param context
     * @return
    ...
    /**
     * Returns all statements matching the specified subject - predicate - object
     * patterns across all named graphs.
     * 
     * @param subject
     * @param predicate
     * @param object
