...
import { FieldValue, FieldError, FieldDefinition, normalizeFieldDefinition } from 'platform/components/forms';

import { FIELD_DEFINITION, FIELD_DEFINITION_CARDINATILIY } from './fixturies/FieldDefinition';
...
describe('FieldCommonTypes', () => {
  ...
  it('normalizes dataType', () => {
    ...
    expect(normalizeFieldDefinition(definition).xsdDatatype).to.be.eql(
