...
public class StoragePathTest {
    ...
    public void testResolve() {
        ...
        assertEquals(StoragePath.parse("foo").resolve(StoragePath.parse("bar/baz")), StoragePath.parse("foo/bar/baz"));
    }
    ...
    public void testRelativize() {
        ...
        assertEquals(StoragePath.parse("foo").relativize(StoragePath.parse("foo/bar")).get(), StoragePath.parse("bar"));
        assertEquals(StoragePath.EMPTY.relativize(StoragePath.parse("foo")).get(), StoragePath.parse("foo"));
        assertEquals(StoragePath.parse("foo/bar").relativize(StoragePath.parse("foo/bar")).get(), StoragePath.EMPTY);
        assertEquals(StoragePath.parse("foo/bar").relativize(StoragePath.parse("foo/bar/baz/qux")).get(),
    ...
    public void testAddExtension() {
        ...
        assertEquals(StoragePath.parse("foo/bar").addExtension("...txt"), StoragePath.parse("foo/bar...txt"));
    }
    ...
    public void testStripExtension() {
        ...
        assertEquals(StoragePath.parse("foo.txt").stripExtension(".txt"), StoragePath.parse("foo"));
        assertEquals(StoragePath.parse("foo/bar...png").stripExtension("...png"), StoragePath.parse("foo/bar"));
        assertEquals(StoragePath.parse("foo.txt").stripExtension(".png"), StoragePath.parse("foo.txt"));
        assertEquals(StoragePath.parse("foo.txt/bar").stripExtension(".txt"), StoragePath.parse("foo.txt/bar"));
    }
