...
/**
 * An object holding the parameters of a keyword-search clause in a SPARQL
 * query. The parameters expressed as {@link Var} objects that either have a
 * value assigned or contain the name of the corresponding SPARQL variable.
 * 
