...
import org.researchspace.sail.rest.AbstractServiceWrappingSailConnection.RESTParametersHolder;
 ...
 * in particular, for extracting input and output parameters from the SPARQL
 * {@link StatementPattern}s passed to the service.
 * 
...
public class RESTWrappingSailUtils {
    ...
    /**
     * Collects constants (either literals or resources) which appear as objects of
    ...
    /**
     * Collects {@Literal} constants which appear as objects of
     * <code>propertyIri</code> and (optional) <code>subjectVariable</code>.
     * 
     * @param statementPatterns
     * @param subjectVariable
     ...
     * @return
     */
    public static List<Literal> getLiteralObjectInputParameters(Collection<StatementPattern> statementPatterns,
            Var subjectVariable, IRI propertyIri) {
        return getObjectInputParameters(statementPatterns, subjectVariable, propertyIri).stream()
                .filter(val -> (val instanceof Literal)).map(val -> (Literal) val).collect(Collectors.toList());
    }

    /**
     * Collects {Resource} constants which appear as objects of
     * <code>propertyIri</code> and (optional) <code>subjectVariable</code>.
     * 
     * @param statementPatterns
     * @param subjectVariable
     ...
     * @return
     */
    public static List<Resource> getResourceObjectInputParameters(Collection<StatementPattern> statementPatterns,
            Var subjectVariable, IRI propertyIri) {
        return getObjectInputParameters(statementPatterns, subjectVariable, propertyIri).stream()
                .filter(val -> (val instanceof Resource)).map(val -> (Resource) val).collect(Collectors.toList());
    }

    /**
     * Retrieves a single constant (either literal or resource) which appears as an
     * object of <code>propertyIri</code> and (optional)
     * <code>subjectVariable</code>.
     * 
     * @param statementPatterns
     * @param subjectVariable
     * @param propertyIri
    ...
    /**
     * Retrieves a single {@Literal} constant which appears as an object of
     * <code>propertyIri</code> and (optional) <code>subjectVariable</code>.
     * 
     * @param statementPatterns
     * @param subjectVariable
     ...
     * @return
     */
    public static Optional<Literal> getLiteralObjectInputParameter(Collection<StatementPattern> statementPatterns,
            Var subjectVariable, IRI propertyIri) {
    ...
    /**
     * Retrieves a single {@Resource} constant which appears as an object of
     * <code>propertyIri</code> and (optional) <code>subjectVariable</code>.
     * 
     * @param statementPatterns
     * @param subjectVariable
     ...
     * @return
     */
    public static Optional<Resource> getResourceObjectInputParameter(Collection<StatementPattern> statementPatterns,
            Var subjectVariable, IRI propertyIri) {
     ...
     * @return
     */
    public static Optional<Var> getObjectOutputVariable(Collection<StatementPattern> statementPatterns,
            Var subjectVariable, IRI propertyIri) {
        return statementPatterns.stream()
                .filter(stmtPattern -> (predicateEquals(stmtPattern, propertyIri)
    ...
    /**
     * Retrieves a variable appearing as subject of <code>propertyIri</code> and
     * (optional) <code>objectVariable</code>.
     * 
     * @param statementPatterns
     * @param subjectVariable
     * @param propertyIri
     * @return
     */
    public static Optional<Var> getSubjectOutputVariable(Collection<StatementPattern> statementPatterns,
            Var objectVariable, IRI propertyIri) {
        return statementPatterns.stream()
                .filter(stmtPattern -> (predicateEquals(stmtPattern, propertyIri)
    ...
    public static void addBindingIfExists(RESTParametersHolder parametersHolder, Map<String, Object> resMap,
    ...
    public static void addBindingFromJsonPathIfExists(RESTParametersHolder parametersHolder, Object resMap,
    ...
    private static void addToBindingSet(MapBindingSet bs, String variableName, Object objVal, IRI dataType) {
        Value rdfValue;
    ...
    private static boolean subjectEquals(StatementPattern pattern, Var subjectVar) {
        return subjectVar.hasValue() ? subjectEquals(pattern, (Resource) subjectVar.getValue())
                : subjectEquals(pattern, subjectVar.getName());
    }
    ...
    private static boolean objectEquals(StatementPattern pattern, Var objectVar) {
        return objectVar.hasValue() ? objectEquals(pattern, objectVar.getValue())
                : objectEquals(pattern, objectVar.getName());
    }

    private static boolean predicateAndSubjectVarMatch(StatementPattern stmtPattern, Var subjectVariable,
            IRI propertyIri) {
