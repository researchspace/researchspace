...
import {
  Component, DOM as D, Props, ReactNode, createElement, Props as ReactProps, createFactory,
  SFC, ComponentClass, cloneElement, ReactElement,
} from 'react';
...
import { listen, init as initNavigation, getCurrentUrl } from 'platform/api/navigation';
...
import { GlobalContextProvider } from 'platform/api/events';

import PageComponent from './page/Page';


import { TemplateItemComponent } from 'platform/components/ui/template';
document.registerElement('mp-template-item', TemplateItemComponent);
...
window.addEventListener('DOMContentLoaded', function () {
  Kefir.combine(
    [initNavigation(), getRegisteredPrefixes(), ConfigHolder.initializeConfig()],
    (url, prefixes) => {
