...
import { TreePickerInput, TreePickerInputProps } from '../inputs';
...
class FieldEditorComponent extends Component<Props, State> {
  ...
  private renderEditor = () => {
    ...
    return D.div(
      {className: 'field-editor-form-container'}, 
        D.div( {className: 'field-editor-form-inputs'},
          row({
            label: 'Label*',
          ...
          row({
            ...
            createElement(SemanticTreeInput, {
              ...
              createElement(ResourceLinkComponent, {
                  iri: 'http://www.researchspace.org/resource/assets/FieldDefinitionCategory',
                  target: '_blank'
                }, 
                D.div(
                { className: 'input-group-btn' },
          ...
          /* row({
            ...
            expanded: true,
            element: D.div({ className: 'input-group' }, [
            createElement(TreePickerInput, {
              scheme: categoryScheme.value
              } as TreePickerInputProps),
              createElement(ResourceLinkComponent, {
                  iri: 'http://www.researchspace.org/resource/assets/FieldDefinitionCategory',
                  target: '_blank'
                }, 
      ...
      D.div(
        {className: 'field-editor-form-btns'},
        bsrow(
          {},
          bscol({ md: 3 }),
          bscol(
