 ...
 *
 */
public class JsonObjectArrayFromSelectSource {
    private static final Logger logger = LogManager.getLogger(JsonObjectArrayFromSelectSource.class);
    ...
    public String jsonObjectArrayFromSelect(String param0, Options options) throws IOException {
        ...
        return new Handlebars.SafeString(StringEscapeUtils.escapeHtml4(
            JsonObjectArrayFromSelectSource.transformTupleQueryResultToJSON(queryString, options, Optional.empty()))
        ).toString();
    }
