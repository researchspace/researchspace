...
public class MetaphactsHandlebarsTest extends JerseyTest {
    ...
    public void setup() throws Exception {
        ...
        handlebars = new MetaphactsHandlebars(null,
    ...
    public void jsonArrayFromSelectHelperTest() throws Exception {
        ...
        // test this parameterization
        Assert.assertEquals("[&quot;http:\\/\\/www.metaphacts.com\\/handlebars&quot;]",
    ...
    public void jsonObjectArrayFromSelectHelperTest() throws Exception {
        ...
        // test this parameterization
        Assert.assertEquals("[{&quot;a&quot;:&quot;http:\\/\\/www.metaphacts.com\\/handlebars&quot;}]",
                handlebars
    ...
    public void fieldDefinitionsHelperTest() throws Exception {
         ...
         */
        String expectedAllDefinitions = IOUtils.toString(MetaphactsHandlebars.class.getResourceAsStream(
    ...
    public void searchConfigFromFieldsHelperTest() throws Exception {
        ...
        String expectedBaseConfig = IOUtils.toString(MetaphactsHandlebars.class.getResourceAsStream(
    ...
    private LDPResource loadFieldResource(LDPApiInternal ldpApi, String fieldName, String resourcePath)
        ...
        return ldpApi.createLDPResource(Optional.of(fieldName),
                ...
                FieldDefinitionContainer.IRI, "http://www.metaphacts.com/field/testinstance/");
    }

    private String readTextResource(String resourcePath) throws IOException {
        return IOUtils.toString(MetaphactsHandlebars.class.getResourceAsStream(resourcePath), StandardCharsets.UTF_8);
    }
