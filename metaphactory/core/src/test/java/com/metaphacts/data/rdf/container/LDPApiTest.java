...
public class LDPApiTest extends AbstractLDPTest {
    ...
    public void addResourceToContainer() throws Exception {
        ...
        //assert that what is stored in the container is actually a superset of what have been committed
        assertTrue(Models.isSubset(TestUtils.readTurtleInputStreamIntoModel(TestUtils.readPlainTextTurtleInput(FILE_DUMMY_RESOURCE_TTL), res.getResourceIRI(), res.getContextIRI()), res.getModel()));
    ...
    public void testGetLDPResource() throws Exception {
        ...
        assertNotNull(res2);
        assertNotEquals(vf.createIRI(absolutSlugURI), res2.getResourceIRI());
    ...
    public void testExportResource() throws Exception {
        ...
        Model exportedModel = api.exportLDPResource(Lists.newArrayList(res.getResourceIRI()));
