...
/**
 * Default implementation of a {@link SecretResolverRegistry}. This
 * implementation allows both manual registration of {@link SecretResolver}s as
 * well as discovery of instances via the {@link ServiceLoader} by calling
 * {@link #discoverResolvers()}.
 * 
 * <p>
...
public class DefaultSecretResolverRegistry implements SecretResolverRegistry {
    ...
    /**
     * Load {@link SecretResolver} via {@link ServiceLoader}. Note: this currently
     * only checks the main class path, not in apps.
     */
    public void discoverResolvers() {
        ...
        try {
            ...
            logger.warn("Failed to load SecretResolver ({}. resolver): {}", Integer.valueOf(resolvers + 1),
                    e.getMessage());
