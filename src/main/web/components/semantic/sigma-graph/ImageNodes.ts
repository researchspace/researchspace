...
import vertexShaderSource from "sigma/rendering/webgl/shaders/node.image.vert.glsl";
import fragmentShaderSource from "sigma/rendering/webgl/shaders/node.image.frag.glsl";
