 ...
 * @author msc
 */
public interface QueryCatalogAPIClient extends LDPAPIClient<Query<?>> {

	/**
	 * Return all queries registered in the metaphactory.
	 */
	public List<Query<?>> getTemplates() throws APICallFailedException;
	
	/**
	 * Retrun all SELECT queries registered in the metaphactory.
	 */
	public List<SelectQuery> getSelectQueries() throws APICallFailedException;

	/**
	 * Return all ASK queries registered in the metaphactory.
	 */
	public List<AskQuery> getAskQueries() throws APICallFailedException;

	/**
	 * Return all CONSTRUCT queries registered in the metaphactory.
	 */
	public List<ConstructQuery> getConstructQueries() throws APICallFailedException;

	/**
	 * Return all DESCRIBE queries registered in the metaphactory.
	 */
	 ...
	 */
	public Query<?> getQuery(IRI queryId) throws APICallFailedException;
	 ...
	 */
	public SelectQuery getSelectQuery(IRI queryId) throws APICallFailedException;
	 ...
	 */
	public AskQuery getAskQuery(IRI queryId) throws APICallFailedException;
	 ...
	 * @return the query or null if the ID could not be resolved or does not reflect an ASK query
	 */
	public ConstructQuery getConstructQuery(IRI queryId) throws APICallFailedException;
	 ...
	 * @return the query or null if the ID could not be resolved or does not reflect a SELECT query
	 */
	public DescribeQuery getDescribeQuery(IRI queryId) throws APICallFailedException;
