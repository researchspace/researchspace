...
export class OpenedSetView extends React.Component<SetViewProps, void> {
...
export class SetWithItems extends React.Component<SetWithItemsProps, void> {
  static readonly childContextTypes = SetViewContextTypes;
  getChildContext(): SetViewContext {
    return {
      'mp-set-management--set-view': {
...
class SetCaption extends React.Component<SetCaptionProps, void> {
  render() {
...
export class EditableLabel extends React.Component<EditableLabelProps, void> {
  render() {
...
export class ItemsView extends React.Component<ItemsViewProps, void> {
  static readonly childContextTypes = SetViewContextTypes;
  getChildContext(): SetViewContext {
    return {
      'mp-set-management--set-view': {
