...
public class SparqlServletTest extends AbstractIntegrationTest  {
    ...
    public void testNoSelectPermissionGET() throws Exception {
        ...
        try(RepositoryConnection con = rep.getConnection()){
            ...
            when(res.getOutputStream()).thenReturn(outputStream);
            sparqlServlet.doPost(req, res);
            verify(res).sendError(Status.FORBIDDEN.getStatusCode(), "No permission to execute SPARQL Operation SELECT");
    ...
    public void testNoConstructPermission() throws Exception {
        ...
        try(RepositoryConnection con = rep.getConnection()){
            ...
            when(res.getOutputStream()).thenReturn(outputStream);
            sparqlServlet.doPost(req, res);
            verify(res).sendError(Status.FORBIDDEN.getStatusCode(), "No permission to execute SPARQL Operation CONSTRUCT");
    ...
    public void testNoAskPermission() throws Exception {
        ...
        try(RepositoryConnection con = rep.getConnection()){
            ...
            when(res.getOutputStream()).thenReturn(outputStream);
            sparqlServlet.doPost(req, res);
            verify(res).sendError(Status.FORBIDDEN.getStatusCode(), "No permission to execute SPARQL Operation ASK");
    ...
    public void testNoUpdatePermission() throws Exception {
        ...
        try(RepositoryConnection con = rep.getConnection()){
            ...
            when(res.getOutputStream()).thenReturn(outputStream);
            sparqlServlet.doPost(req, res);
            verify(res).sendError(Status.FORBIDDEN.getStatusCode(), "No permission to execute SPARQL Operation UPDATE");
