...
public interface LDPResource {
     ...
     * {@link LDPResource} that will be returned to any client (whether it is a java
     * client accessing the java interfaces or a rest client).
     *
     * <p>
     ...
     * statements neither reflect what is physically stored in the database nor can
     * be used to add or delete statements.
     * </p>
     *
     * @return
     ...
     * content "body" is physically stored. The context is the only resource that
     * can be used to manage the data physically.
     *
     * @return
     */
