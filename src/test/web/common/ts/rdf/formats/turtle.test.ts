...
describe('turtle writer/parser', () => {
  it('conversion beetwen RDF typed literal and N3 literal', () => {
    ...
    expect(turtle.deserialize.n3ValueToRdf(n3Literal)).to.be.deep.equal(literal);
  });
  ...
  it('conversion beetwen RDF Iri and N3 value', () => {
    ...
    expect(turtle.deserialize.n3ValueToRdf(n3Value)).to.be.deep.equal(iri);
  });
  ...
  it('conversion beetwen RDF Bnode and N3 value', () => {
    ...
    expect(n3Value).to.be.equal(expectedN3Value);
    expect(turtle.deserialize.n3ValueToRdf(n3Value)).to.be.deep.equal(bnode);
  });
  ...
  it('conversion beetwen RDF Triple and N3 Triple', () => {
    const triple = Rdf.triple(
      ...
      Rdf.literal('5', vocabularies.xsd.integer)
    );
    ...
    expect(turtle.deserialize.n3TripleToRdf(n3Triple)).to.be.deep.equal(triple);
  });
