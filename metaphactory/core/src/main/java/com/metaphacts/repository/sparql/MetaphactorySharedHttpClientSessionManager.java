 ...
 *
 */
public class MetaphactorySharedHttpClientSessionManager extends SharedHttpClientSessionManager {
    
    private final ExecutorService executor;
    private final Configuration config;
    
    public MetaphactorySharedHttpClientSessionManager(Configuration config) {
        this.config = config;
    ...
    @Override
    public MetaphactorySPARQLProtocolSession createSPARQLProtocolSession(String queryEndpointUrl, String updateEndpointUrl) {
        MetaphactorySPARQLProtocolSession session = new MetaphactorySPARQLProtocolSession(getHttpClient(), executor);
