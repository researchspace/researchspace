...
import org.researchspace.security.ShiroGuiceModule;
...
public class GuiceServletConfig extends GuiceServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        /**
         * Set context param properties as System properties. This allow override of
         * platform config properties using context-param in web.xml
         */
    ...
    protected Injector getInjector() {
        ...
        GuiceServletConfig.injector = platformBaseInjector.createChildInjector(
                ...
                new ShiroGuiceModule(this.servletContext, platformBaseInjector), ShiroWebModule.guiceFilterModule(),
                new PlatformGuiceModule(platformBaseInjector));
        return injector;
    }

    /**
     * Set context param properties as System properevent.getServletContext()ties.
     * This allow override of platform config properties using context-param in
     * web.xml
     */
