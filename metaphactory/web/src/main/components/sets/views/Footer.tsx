...
export class ReorderItemsButton extends React.Component<ReorderingProps, void> {
  render() {
...
export class ReorderConfirmation extends React.Component<ReorderingProps, void> {
  render() {
