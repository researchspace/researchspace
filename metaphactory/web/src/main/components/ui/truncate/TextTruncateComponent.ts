...
import * as ReactTruncateComponent from 'react-truncate';

import { ModuleRegistry } from 'platform/api/module-loader';

import * as TextTruncateExpandCollapseComponent from './TextTruncateExpandCollapseComponent';

const ReactTruncate = createFactory(ReactTruncateComponent);
...
export type component = TextTruncateComponent;
export const component = TextTruncateComponent;
