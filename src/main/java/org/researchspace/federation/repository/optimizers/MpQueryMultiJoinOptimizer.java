...
/**
 * A query optimizer that re-orders nested Joins. Copies
 * {@link QueryMultiJoinOptimizer} adding the logic for join order optimization
 * based on declared inputs/outputs of Ephedra services.
 * 
 * @deprecated After the query hints implementation, the process is split into
 *             substages, realized by {@link MpQueryNaryJoinExtractor},
 *             {@link MpQueryJoinOrderOptimizer},
