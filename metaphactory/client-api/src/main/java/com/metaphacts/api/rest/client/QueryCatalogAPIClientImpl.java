 ...
 * @author msc
 */
public class QueryCatalogAPIClientImpl extends LDPAPIClientImpl<Query<?>> implements QueryCatalogAPIClient {
	...
	public QueryCatalogAPIClientImpl(
		...
		super(endpoint, user, password, containerId, baseIri, new ModelToQueryTransformer());
	}
	...
	@SuppressWarnings("unchecked")
	protected <T extends Query<?>> T getQueryOfType(IRI queryId, Class<T> clazz) throws APICallFailedException {
