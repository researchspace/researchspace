...
public class ModelToQueryTemplateTest extends BaseModelToDtoTest {
    ...
    public void testModelToTemplateTest() throws Exception{
        ...
        assertEquals("Argument to bind the ?friend variable of the query.\nThe value of the argument must be of type xsd:Resource.",arg1.getDescription());
        assertEquals("Argument to bind the ?name variable of the query.\nThe value of the argument must be of type xsd:string.",arg2.getDescription());
