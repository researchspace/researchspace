 ...
 */
public class SerializableParsedTupleQuery {
     ...
     */
    public Map<Projection, SerializableParsedTupleQuery> subQueriesByProjection = 
            new HashMap<Projection, SerializableParsedTupleQuery>();
