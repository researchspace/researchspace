 ...
 * @author msc
 */
public interface QueryFormCatalogAPIClient extends LDPAPIClient<QueryFormConfiguration<QueryTemplate<?>>> {
	 ...
	 */
	public QueryFormConfiguration<QueryTemplate<?>> getFormConfiguration(IRI FormConfigurationId) 
	throws APICallFailedException;
