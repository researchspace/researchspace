...
public class OntologyManager {
    ...
    public OWLOntology loadOntology(IRI ontologyIri, boolean resolveImportClosure)
        ...
        ontologyManager.addOntologyFactory(new MetaphactoryOntologyFactory(loaderConfig));
    ...
    private class MetaphactoryOntologyFactory extends ParsableOWLOntologyFactory {
        private static final long serialVersionUID = 8250010324694004777L;

        protected OWLOntologyLoaderConfiguration loaderConfig;

        public MetaphactoryOntologyFactory(OWLOntologyLoaderConfiguration config) {
            super();
        ...
        public OWLOntology loadOWLOntology(OWLOntologyDocumentSource documentSource,
            ...
            // try to read from metaphactory triple store
    ...
    private InputStream exportOntologyFromRepositoryToInputStream(IRI ontologyIri)
            ...
            try (RepositoryResult<Statement> res = con.getStatements(null, RDF.TYPE, OWL.ONTOLOGY)) {
                while (res.hasNext()) {
                    ...
                    if (it.getContext() != null) {
                        ...
                        logger.warn(
                                "Resource {} which is declared as owl:Ontology is not in any named graph.",
                                it.getContext());
                    }
                }
            }
