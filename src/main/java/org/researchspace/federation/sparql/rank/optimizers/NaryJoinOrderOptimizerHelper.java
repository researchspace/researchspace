...
/**
 * A helper class to support join order optimization taking into account input-
 * and output- dependencies between service calls.
 * 
...
public class NaryJoinOrderOptimizerHelper {
    ...
    public List<TupleExpr> orderJoinOperands() {
        ...
        while (!joinArgs.isEmpty()) {
            TupleExpr tupleExpr = selectNextTupleExprBasedOnInputsOutputs(joinArgs, cardinalityMap, varsMap, varFreqMap,
                    boundVars);
    ...
    protected TupleExpr selectNextTupleExprBasedOnInputsOutputs(List<TupleExpr> expressions,
        ...
        while (!candidateSet.isEmpty()) {
            TupleExpr nextCandidate = selectNextTupleExpr(candidateSet, cardinalityMap, varsMap, varFreqMap, boundVars);
