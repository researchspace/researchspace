 ...
 *
 */
public class MetaphactorySPARQLProtocolSession extends SPARQLProtocolSession {
    private static final Logger logger = LogManager.getLogger(MetaphactorySPARQLProtocolSession.class);

    public MetaphactorySPARQLProtocolSession(HttpClient client, ExecutorService executor) {
