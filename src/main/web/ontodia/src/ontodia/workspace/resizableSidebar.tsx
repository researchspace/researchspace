...
export class ResizableSidebar extends React.Component<Props, State> {
  ...
  private get isHorizontal(): boolean {
    return this.props.dockSide === DockSide.Top || this.props.dockSide === DockSide.Bottom;
  }
  ...
  render() {
    ...
    return (
      <div className={className} style={style}>
        ...
        >
          <div className={`${CLASS_NAME}__handle-btn`} onClick={() => this.toggle({ open: !this.state.open })}></div>
        </DraggableHandle>
      </div>
    );
  }
