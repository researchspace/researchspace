 ...
 * normative reference..
 * <p>
 * Namespace ldp. Prefix: {@code <http://www.w3.org/ns/ldp#>}
 *
 * @see <a href="http://www.w3.org/2012/ldp">http://www.w3.org/2012/ldp</a>
 * @see <a href=
 *      "http://www.w3.org/TR/ldp-ucr/">http://www.w3.org/TR/ldp-ucr/</a>
 * @see <a href="http://www.w3.org/TR/ldp/">http://www.w3.org/TR/ldp/</a>
 * @see <a href=
 *      "http://www.w3.org/TR/ldp-paging/">http://www.w3.org/TR/ldp-paging/</a>
 * @see <a href=
 *      "http://www.w3.org/2011/09/LinkedData/">http://www.w3.org/2011/09/LinkedData/</a>
 * 
...
public class LDP {
     ...
     * patterns and conventions for managing membership. Readers should refer to the
     * specification defining this ontology for the list of behaviors associated
     * with it.
     *
     ...
     * ability to list as member a resource, such as a URI representing a real-world
     * object, that is different from the resource that is created.
     *
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#hasMemberRelation">hasMemberRelation</a>
     */
     ...
     * <p>
     * An LDPC that has the flexibility of choosing what form the membership triples
     * take.
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#IndirectContainer">IndirectContainer</a>
     */
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#insertedContentRelation">insertedContentRelation</a>
     */
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#isMemberOfRelation">isMemberOfRelation</a>
     */
     ...
     * <p>
     * LDP servers should use this predicate as the membership predicate if there is
     * no obvious predicate from an application vocabulary to use.
     *
     ...
     * of ldp:hasMemberRelation or ldp:isMemberOfRelation, the
     * membership-constant-URI might occupy either the subject or object position in
     * membership triples.
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#membershipResource">membershipResource</a>
     */
     ...
     * triple added when a creation request is successful is the URI assigned to the
     ...
     * <p>
     * Link to a page sequence resource, as defined by LDP Paging. Typically used to
     * communicate the sorting criteria used to allocate LDPC members to pages.
     *
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#pageSortCollation">pageSortCollation</a>
     */
     ...
     * Typically used on Link response headers as an extension link relation URI in
     * the rel= parameter.
     *
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#PageSortCriterion">PageSortCriterion</a>
     */
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#pageSortPredicate">pageSortPredicate</a>
     */
     ...
     * <p>
     * URI identifying a LDPC's containment triples, for example to allow clients to
     * express interest in receiving them.
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#PreferContainment">PreferContainment</a>
     */
     ...
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#PreferEmptyContainer">PreferEmptyContainer</a>
     */
     ...
     * <p>
     * URI identifying a LDPC's membership triples, for example to allow clients to
     * express interest in receiving them.
     *
     ...
     * <p>
     * URI identifying the subset of a LDPC's triples present in an empty LDPC, for
     * example to allow clients to express interest in receiving them. Currently
     * this excludes containment and membership triples, but in the future other
     * exclusions might be added. This definition is written to automatically
     * exclude those new classes of triples.
     *
     * @see <a href=
     *      "http://www.w3.org/ns/ldp#PreferMinimalContainer">PreferMinimalContainer</a>
     */
