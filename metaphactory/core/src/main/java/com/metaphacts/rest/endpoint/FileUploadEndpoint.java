...
public class FileUploadEndpoint {
    ...
    public Response createDocument(
        ...
        FileContainer fileContainer = (FileContainer) LDPImplManager.getLDPImplementation(FileContainer.IRI, Sets.newHashSet(LDP.Container, LDP.Resource), repositoryManager.getAssetRepository());//ldp.getLDPResource(FileContainer.URI);
