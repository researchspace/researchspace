/**
 * ResearchSpace
 * Copyright (C) 2022, © Trustees of the British Museum
 *
...
export interface DirectFolderUploaderState {
...
export interface DirectFolderUploaderProps {
  /**
 ...
 */
export class DirectFolderUploader extends Component<DirectFolderUploaderProps, DirectFolderUploaderState> {
  private readonly cancellation = new Cancellation();

  constructor(props: DirectFolderUploaderProps, context: any) {
    super(props, context);
    const objectKind =
  ...
  componentWillReceiveProps(newProps: DirectFolderUploaderProps) {
  ...
  render() {
    ...
    const renderedPath = `${storageId}: ${this.getFolder(undefined)}/${path.name || 'undefined'}`;
...
export default DirectFolderUploader;
