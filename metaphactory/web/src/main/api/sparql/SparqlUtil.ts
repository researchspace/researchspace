...
import { isQuery } from './TypeGuards';
...
let RegisteredPrefixes: { [key: string]: string } = {};
...
export function preferredLabelPattern(): string {
  const preferredLabels = ConfigHolder.getUIConfig().preferredLabels;
