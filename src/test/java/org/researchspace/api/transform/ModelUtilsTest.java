...
public class ModelUtilsTest {
    ...
    public void createModel() {
        ArrayList<Statement> stmts = Lists.<Statement>newArrayList(vf.createStatement(subj, pred, obj),
                vf.createStatement(subj2, pred2, obj2), vf.createStatement(subj3, pred3, obj3));
    ...
    public void testGetNotNullSubjectIRI_NullException() {
        ...
        exception.expectMessage(containsString(
                "Subject of { ?subject http://www.test.de/predicate1 http://www.test.de/subject1 } is not an IRI or is null."));
        assertEquals(subj, getNotNullSubjectIRI(model, pred, subj));
    }

    @Test
    public void testGetNotNullSubjectIRI_NotIRIException() {
        // TODO I think Sesame exception is misleading .. should be "Unexpected subject
        // term"
        exception.expect(ModelException.class);
    ...
    public void testGetNotNullObjectIRI_NullException() {
        exception.expect(ModelException.class);
        exception.expectMessage(containsString(
                "Object of { http://www.test.de/object1 http://www.test.de/predicate1 ?object } is not an IRI or is null"));
