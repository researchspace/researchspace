...
export namespace Permissions {
  export const templateSave = 'templates:edit:save';

  /** See `SparqlQueryEditor` */
  const sparqlQueryEditor = 'ui:component:view:mp:sparql:query:editor';
  /** Button to save query to the query catalog. */
  export const queryEditorSave = `${sparqlQueryEditor}:save`;
