...
export class ContextCapturer {
  ...
  constructor(private contexts = new Map<string, DataContext>()) {}
...
export class CapturedContext {
  ...
  private contexts: ReadonlyMap<string, DataContext>;

  constructor(contexts?: ReadonlyMap<string, DataContext>) {
    this.contexts = contexts || new Map<string, DataContext>();
  }
  ...
  capture() {
    return new ContextCapturer(new Map(this.contexts as Map<string, DataContext>));
  }
}
