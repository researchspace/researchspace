...
public class SparqlServiceUtils {
    ...
    public static Map<String, Var> extractInputParameters(TupleExpr tupleExpr, ServiceDescriptor descriptor) {
        return extractParameters(tupleExpr, descriptor.getInputParameters());
    }

    public static Map<String, Var> extractOutputParameters(TupleExpr tupleExpr, ServiceDescriptor descriptor) {
    ...
    private static Var retrieveVarForParameter(ServiceDescriptor.Parameter param, List<StatementPattern> patterns) {
                ...
                if (matches(inputPattern, subjectPattern)) {
                    if ((matchedVar != null) && !matchedVar.equals(inputPattern.getSubjectVar())) {
                        throw new IllegalStateException(
                                "The parameter " + param.getParameterName() + " has more than one binding");
                    } else {
