...
public class OverlayImageProcessorTest extends AbstractIntegrationTest {
    ...
    PointedGraph getSimpleOperation(String topImage, double topOpacity, String bottomImage, double bottomOpacity,
            String name) {
        ...
        Model model = new LinkedHashModel(Lists.newArrayList(vf.createStatement(overlayIri, RDF.TYPE, RSO.THING_CLASS),
    ...
    List<OverlayImageProcessor.BlendingParam> getParams(String topImage, double topOpacity, String bottomImage,
            double bottomOpacity) {
        IRI topImageUri = vf.createIRI("http://researchspace.org/test/Overlay1/" + topImage);
        IRI bottomImageUri = vf.createIRI("http://researchspace.org/test/Overlay1/" + bottomImage);
        return Lists.newArrayList(new OverlayImageProcessor.BlendingParam(topImageUri, 1, topOpacity),
                new OverlayImageProcessor.BlendingParam(bottomImageUri, 2, bottomOpacity));
    }

    @Test
    public void testImageOverlay5050() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/5050"),
                getParams("circlePNG", 0.5, "squarePNG", 0.5));
    ...
    public void testImageOverlay0100() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/100"),
                getParams("circlePNG", 0.0, "squarePNG", 1.0));
    ...
    public void testImageOverlay1090() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/1090"),
                getParams("circlePNG", 0.1, "squarePNG", 0.9));
    ...
    public void testImageOverlay9010() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/9010"),
                getParams("circlePNG", 0.9, "squarePNG", 0.1));
    ...
    public void testImageOverlay1000() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/1000"),
                getParams("circlePNG", 1.0, "squarePNG", 0.0));
    ...
    public void testImageOverlayTIFF() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/testTIFF"),
                getParams("circleTIFF", 0.5, "squareTIFF", 0.5));
    ...
    public void testImageOverlayJPG() throws Exception {
        getOverlayImageFileProcessor().applyOverlay(vf.createIRI("http://researchspace.org/images/testJPG"),
                getParams("circleJPG", 0.5, "squareJPG", 0.5));
    ...
    public void testGraphParse() throws Exception {
        PointedGraph graph = getOverlayImageProcessor()
                .convertToCRMDig(getSimpleOperation("circlePNG", 0.1, "squarePNG", 0.9, "parseTest"));
        assertTrue("Graph should have rewritten IRI for event",
                graph.getGraph().contains(vf.createIRI("http://researchspace.org/test/parseTest/event"),
                        CidocCRM.P14_CARRIED_OUT_BY_PROPERTY, getUserURI()));
    }

    private boolean compareImages(String referenceInClasspath, String testInTempFolder) throws Exception {
        BufferedImage referenceImg = ImageIO.read(OverlayImageProcessorTest.class
                .getResourceAsStream("/org/researchspace/imageoverlay/" + referenceInClasspath));
    ...
    public static void setup() throws Exception {
        ...
        FileUtils.copyInputStreamToFile(
                OverlayImageProcessorTest.class.getResourceAsStream("/org/researchspace/imageoverlay/circlePNG.png"),
                new File(tempWorkingDir, "circlePNG.png"));
        FileUtils.copyInputStreamToFile(
                OverlayImageProcessorTest.class.getResourceAsStream("/org/researchspace/imageoverlay/squarePNG.png"),
                new File(tempWorkingDir, "squarePNG.png"));
        FileUtils.copyInputStreamToFile(
                OverlayImageProcessorTest.class.getResourceAsStream("/org/researchspace/imageoverlay/circleJPG.jpg"),
                new File(tempWorkingDir, "circleJPG.jpg"));
        FileUtils.copyInputStreamToFile(
                OverlayImageProcessorTest.class.getResourceAsStream("/org/researchspace/imageoverlay/squareJPG.jpg"),
                new File(tempWorkingDir, "squareJPG.jpg"));
        FileUtils.copyInputStreamToFile(
                OverlayImageProcessorTest.class.getResourceAsStream("/org/researchspace/imageoverlay/circleTIFF.tiff"),
                new File(tempWorkingDir, "circleTIFF.tiff"));
        FileUtils.copyInputStreamToFile(
                OverlayImageProcessorTest.class.getResourceAsStream("/org/researchspace/imageoverlay/squareTIFF.tiff"),
                new File(tempWorkingDir, "squareTIFF.tiff"));
    }
