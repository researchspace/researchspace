...
/**
 * After applying other optimizers,
 * the original operands of executeFirst / executeLast directives 
 * can be moved in the query tree such that they themselves no longer
 * appear as join arguments.
 * In this class, we replace them in the query hints setup 
 * with the actual join arguments, if these arguments represent unary tuple operators.
 * 
...
public class MpQueryHintsSyncOptimizer implements QueryOptimizer {
    ...
    /**
     * Enriches the list of query hints with "derived" tuple exprs:
     * those which represent unary operators over the original ones.
     * 
