...
describe('GraphInternals', () => {
  it('build data with default options', () => {
    ...
    const graphData = GraphInternals.prepareGraphData(config)(SPARQL_CONSTRUCT_RESPONSE);
    ...
    const expectedGraphData = [
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.alice.toString() + foaf.member.toString() + person.W3C.toString(),
          node: foaf.member,
          resource: foaf.member.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.mike.toString() + foaf.member.toString() + person.W3C.toString(),
          node: foaf.member,
          resource: foaf.member.toString(),
      ...
      },
      {
        ...
        data: {
          id:
            ...
            vocabularies.rdfs.label.toString() +
            Rdf.literal('Alice').toString(),
          node: vocabularies.rdfs.label,
          resource: vocabularies.rdfs.label.toString(),
          source: person.W3C.toString() + person.alice.toString(),
          target: Rdf.literal('Alice').toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.alice.toString() + foaf.knows.toString() + person.bob.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.W3C.toString() + person.alice.toString(),
          target: person.bob.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.alice.toString() + foaf.knows.toString() + person.carol.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.W3C.toString() + person.alice.toString(),
          target: person.carol.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.mike.toString() + foaf.knows.toString() + person.carol.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.W3C.toString() + person.mike.toString(),
          target: person.carol.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.carol.toString() + foaf.knows.toString() + person.W3C.toString() + person.mike.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.carol.toString(),
          target: person.W3C.toString() + person.mike.toString(),
  ...
  it('build data with group-by and node mirroring', () => {
    ...
    const graphData = GraphInternals.prepareGraphData(config)(COMPLEX_GROUPED_DATA);
    ...
    const expectedGraphData = [
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.mike.toString() + foaf.knows.toString() + person.sam.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.W3C.toString() + person.mike.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C.toString() + person.alice.toString() + foaf.knows.toString() + person.sam.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.W3C.toString() + person.alice.toString(),
          target: person.sam.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C2.toString() + person.mike.toString() + foaf.knows.toString() + person.sam.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
          source: person.W3C2.toString() + person.mike.toString(),
          target: person.sam.toString(),
      ...
      },
      {
        group: 'edges',
        data: {
          id: person.W3C2.toString() + person.bob.toString() + foaf.knows.toString() + person.sam.toString(),
          node: foaf.knows,
          resource: foaf.knows.toString(),
