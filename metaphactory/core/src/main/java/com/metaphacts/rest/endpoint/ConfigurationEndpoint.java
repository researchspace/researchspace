...
import com.metaphacts.config.ConfigPermissionUtil;
import com.metaphacts.config.Configuration;
import com.metaphacts.config.Configuration.ConfigParameterValueInfo;
import com.metaphacts.config.UnknownConfigurationException;
import com.metaphacts.config.ConfigPermissionUtil.APIUsageMode;
...
public class ConfigurationEndpoint {
    ...
    public Response listConfigurationParamsInGroup(@PathParam("configGroup") String configGroup) {
        ...
        try {
            ...
            for( Entry<String, ConfigParameterValueInfo> entry : unfilteredMap.entrySet()){
                ...
                final String requiredReadPermission = 
                        ConfigPermissionUtil.getPermissionString(
    ...
    public Response setConfigurationValue(
        ...
        try{
            ...
            final String requiredWritePermission = 
                    ConfigPermissionUtil.getPermissionString(
            ...
            systemConfig.setProperty(configGroup, configIdInGroup, configValue);
