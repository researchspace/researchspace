...
import org.researchspace.federation.sparql.parser.MpSPARQLParser;

/**
 * Custom implementation of {@link SailRepositoryConnection} for
 * {@link MpFederationSailRepository}. Uses the custom {@link MpSPARQLParser} to
 * parse SELECT queries and extract custom aggregation functions.
 * 
...
public class MpFederationSailRepositoryConnection extends SailRepositoryConnection {
    ...
    public SailBooleanQuery prepareBooleanQuery(QueryLanguage ql, String queryString, String baseUri)
        ...
        QueryParser parser = new MpSPARQLParser(this.getSailConnection().getFederation());
