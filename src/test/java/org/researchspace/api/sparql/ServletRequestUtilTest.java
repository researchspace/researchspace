...
public class ServletRequestUtilTest {
    ...
    public void testGetPreferredMIMETypeHTML() throws Exception {
        ...
        Assert.assertEquals("text/html",
                ServletRequestUtil.getPreferredMIMEType(Lists.newArrayList("text/html", "application/xml"), req).get());
    }
    ...
    public void testGetPreferredMIMETypeSparqlResultJson() throws Exception {
        ...
        Assert.assertEquals(TupleQueryResultFormat.JSON.getDefaultMIMEType(), ServletRequestUtil
                .getPreferredMIMEType(Lists.newArrayList(TupleQueryResultFormat.JSON.getDefaultMIMEType()), req).get());
    }
    ...
    public void testGetContentType() throws Exception {
        ...
        when(req.getContentType()).thenReturn("application/sparql-query; charset=utf-8");
        Assert.assertEquals("application/sparql-query", ServletRequestUtil
                .getContentType(req, Optional.of(Lists.newArrayList("application/sparql-query"))).get());
