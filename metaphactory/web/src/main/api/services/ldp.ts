...
export class LdpService {
    ...
    constructor(container: string, context: LdpServiceContext = {repository: 'assets'}) {
    ...
    protected getServiceUrl(urlSuffix = '', queryParams: {[param: string]: string | string[]} = {}) {
      ...
      const urlQuery = URI.buildQuery(_.assign(this.context || {}, queryParams));
...
export const RootContainer = function(context: LdpServiceContext) {
