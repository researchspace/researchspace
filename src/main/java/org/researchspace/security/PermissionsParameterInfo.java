...
public class PermissionsParameterInfo {
     ...
     * @param permissions     Iterates over all the fields annotated with
     *                        PermissionsDocField and checks for description,
     *                        pattern and example.
     */
    ...
    private void setFieldParameterValues(Field field, Class<?> permissionGroup,
            ArrayList<PermissionsParameterInfo> permissions) {
