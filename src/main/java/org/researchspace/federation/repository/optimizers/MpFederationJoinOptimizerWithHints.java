...
/**
 * Repeats the procedure from the superclass, but does not merge too consequent
 * statement patterns that are to be sent to the same source into a local join,
 * if one of them is affected by a query hint (executeFirst or executeLast).
 * 
 */
