...
declare namespace Chai {
  ...
  interface Assertion {
     ...
     * @param selector
     */
    descendants(selector?: any): Assertion;
...
declare function chaiEnzyMe(wrapper?: (debugWrapper: any) => string): (chai: any) => void;
declare module chaiEnzyMe { }

export default chaiEnzyMe;
