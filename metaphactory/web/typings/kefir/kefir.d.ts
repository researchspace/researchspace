declare module Kefir {
  ...
  interface KefirStatic {
     ...
     */
    constantError<T>(error: T): Property<T>;
     ...
     */
    fromPoll<T>(interval: number, fn: () => T): Stream<T>;
     ...
     */
    withInterval<T>(interval: number, handler: (emitter: Emitter<T>) => never): Stream<T>;
     ...
     */
    fromCallback<T>(f: (cb: (result: T) => void) => void): Stream<T>;
     ...
     */
    merge<T>(obss: Array<Observable<T>>): Stream<T>;
     ...
     */
    zip<T>(sources: Array<Observable<T>>): Stream<T[]>;

    /**
     * @see zip
     */
    zip<X1, X2>(sources: [Observable<X1>, Observable<X2>]): Stream<[X1, X2]>;

    /**
     * @see zip
     */
    zip<X1, X2, X3>(sources: [Observable<X1>, Observable<X2>, Observable<X3>]): Stream<[X1, X2, X3]>;

    /**
     * @see zip
     */
    zip<X1, X2, X3, X4>(sources: [Observable<X1>, Observable<X2>, Observable<X3>, Observable<X4>]): Stream<[X1, X2, X3, X4]>;
     ...
     */
    combine<T>(obs: Array<Observable<T>>): Stream<Array<T>>;
     ...
     * @see combine
     */
    combine<X1, X2>(obss: [Observable<X1>, Observable<X2>]): Stream<[X1, X2]>;
  ...
  interface Stream<A> extends Observable<A> {
    /**
  ...
  interface Property<A> extends Observable<A> {
