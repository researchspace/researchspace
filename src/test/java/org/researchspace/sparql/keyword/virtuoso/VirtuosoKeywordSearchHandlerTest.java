...
import org.researchspace.sparql.keyword.virtuoso.VirtuosoKeywordSearchHandler.VirtuosoSparqlFullTextSearchSerializerQueryVisitor;
...
public class VirtuosoKeywordSearchHandlerTest {
    ...
    public void prepare() {
        ...
        serializerVisitor = new VirtuosoSparqlFullTextSearchSerializerQueryVisitor();
    }
    ...
    public void testSimple() throws Exception {
        ...
        checkLists(query, Lists.newArrayList("?subj <http://www.w3.org/2000/01/rdf-schema#label> ?label .",
    ...
    public void testSimpleWithMultiplePredicates() throws Exception {
        ...
        pattern.setValueVar(TupleExprs.createConstVar(VF.createLiteral("token*")));
        String query = handler.generateTargetQuery(tupleExpr, parserVisitor, serializerVisitor);
        checkLists(query, Lists.newArrayList("?subj ?pred ?label .",
    ...
    public void testShortToken() throws Exception {
        ...
        // "FILTER( LCASE(?label) LIKE
        // \"tok%\"^^<http://www.w3.org/2001/XMLSchema#string>) ."));
        checkLists(query, Lists.newArrayList("?subj <http://www.w3.org/2000/01/rdf-schema#label> ?label .",
