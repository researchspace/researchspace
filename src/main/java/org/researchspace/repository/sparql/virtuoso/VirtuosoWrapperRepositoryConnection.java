...
public class VirtuosoWrapperRepositoryConnection extends RepositoryConnectionWrapper {
    ...
    private static final Logger logger = LogManager.getLogger(VirtuosoWrapperRepositoryConnection.class);

    protected static VirtuosoKeywordSearchHandler keywordSearchHandler = new VirtuosoKeywordSearchHandler();

    public VirtuosoWrapperRepositoryConnection(Repository repository, RepositoryConnection delegate) {
     ...
     * @throws RepositoryException
     */
    protected void setBindings(Query query, Resource subj, IRI pred, Value obj, Resource... contexts)
            throws RepositoryException {
        if (subj != null) {
