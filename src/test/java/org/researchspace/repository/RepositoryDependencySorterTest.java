...
import org.researchspace.repository.RepositoryDependencySorter;
...
public class RepositoryDependencySorterTest {
    ...
    private static class DummyRepoWithDepsConfig extends AbstractRepositoryImplConfig
    ...
    private static class DummySailWithDepsConfig extends AbstractSailImplConfig implements MpDelegatingImplConfig {
    ...
    private RepositoryConfig createTestRepoWithDepsConfig(String name, List<String> dependencyNames) {
    ...
    public void testSimpleDependency() throws Exception {
        ...
        assertEquals(Lists.newArrayList("first", "second"), Lists.newArrayList(sorted.keySet()));
    }
    ...
    public void testTree() {
        ...
        assertThat(Lists.newArrayList(sorted.keySet()), hasItemsInOrder("second", "third", "fourth"));
    }
