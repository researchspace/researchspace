 ...
 * @author msc, jt
 */
public class QueryFormCatalogAPIClientImpl extends LDPAPIClientImpl<QueryFormConfiguration<QueryTemplate<?>>> implements QueryFormCatalogAPIClient {
	...
	public QueryFormCatalogAPIClientImpl(
		...
		super(endpoint, user, password, containerId, baseIri, 
	...
	@Override
	public QueryFormConfiguration<QueryTemplate<?>> getFormConfiguration(IRI formId) throws APICallFailedException {
	...
	@Override
	public QueryFormConfiguration<SelectQueryTemplate> getSelectBasedFormConfiguration(IRI FormConfigurationId) 
	throws APICallFailedException {
	...
	@Override
	public QueryFormConfiguration<ConstructQueryTemplate> getConstructBasedFormConfiguration(IRI FormConfigurationId) 
	throws APICallFailedException {
	...
	@Override
	public QueryFormConfiguration<AskQueryTemplate> getAskBasedFormConfiguration(IRI FormConfigurationId) 
	throws APICallFailedException {
	...
	protected <T extends QueryTemplate<?>> QueryFormConfiguration<T> getFormConfiguration(IRI formConfigurationId, Class<T> clazz) 
	throws APICallFailedException {
