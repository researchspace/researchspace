...
public class ContainerEndpointTest extends JerseyTest {
    ...
    /**
     * Check that admin user can delete any resource from query container. Test for
     * api:ldp:*
     */
    @Test
    ...
    /**
     * Check that admin user can get any resource from query container. Test for
     * api:ldp:*
     */
    @Test
    @SubjectAware(username = "admin", password = "admin", configuration = queryContainerPermissionsShiroFile)
    ...
    /**
     * Check that admin user can add resource to query container and then delete it.
     * Test for api:ldf:* permission
     */
    @Test
    @SubjectAware(username = "admin", password = "admin", configuration = queryContainerPermissionsShiroFile)
    ...
    public void testCreateAndDeleteWithStorage() throws Exception {
        ...
        StoragePath objectId = ObjectKind.LDP.resolve(RepositoryManager.ASSET_REPOSITORY_ID)
                .resolve(StoragePath.encodeIri(resourceIri)).addExtension(".trig");
