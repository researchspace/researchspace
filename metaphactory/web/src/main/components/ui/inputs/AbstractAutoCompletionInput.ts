...
import {
  Component, Props as ReactProps, createFactory, PropTypes, CSSProperties, createElement,
} from 'react';
...
ReactSelectComponent.Async.propTypes['noResultsText'] = PropTypes.oneOfType([
  PropTypes.node,
  PropTypes.string,
]);
