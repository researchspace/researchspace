...
export const GlobalEventsContextKey = 'GLOBAL_EVENTS';
export type GlobalEventsContext = {
  [K in typeof GlobalEventsContextKey]: EventsApi
};

export const GlobalEventsContextTypes = {
  [GlobalEventsContextKey]: PropTypes.any.isRequired,
};
